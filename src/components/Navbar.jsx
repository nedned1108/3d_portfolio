  ...
  return (
    ...
    >
      <div className='flex items-center justify-between w-full max-w-7xl mx-auto'>
        ...
        >
          <img src={ned_logo} alt='logo' className='w-9 h-9 object-contain rounded' />
          <p className='text-white text-[18px] font-bold cursor-pointer flex' >Ned &nbsp;
            <span className='sm:block hidden' >| Java Developer</span></p>
        </Link>
